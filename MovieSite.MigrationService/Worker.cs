    ...
    IHostApplicationLifetime hostApplicationLifetime) : BackgroundService
{
    ...
    private static async Task EnsureDatabaseAsync(MovieDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    private static async Task RunMigrationAsync(MovieDbContext dbContext, CancellationToken cancellationToken)
    {
        var strategy = dbContext.Database.CreateExecutionStrategy();
        await strategy.ExecuteAsync(async () =>
        {
